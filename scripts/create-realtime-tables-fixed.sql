...
DROP POLICY IF EXISTS "Allow all operations on login_credentials" ON login_credentials;
...
-- Tentar habilitar realtime (pode falhar se já estiver habilitado, mas não causará erro)
DO $$
BEGIN
